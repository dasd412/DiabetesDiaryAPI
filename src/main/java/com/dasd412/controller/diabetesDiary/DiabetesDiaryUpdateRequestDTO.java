...
public class DiabetesDiaryUpdateRequestDTO {
    ...
    public DiabetesDiaryUpdateRequestDTO(int fastingPlasmaGlucose, int breakfastBloodSugar, int lunchBloodSugar, int dinnerBloodSugar, String remark) {
    ...
    static public class Builder{
        ...
        public DiabetesDiaryUpdateRequestDTO build(){
            return new DiabetesDiaryUpdateRequestDTO(fastingPlasmaGlucose,breakfastBloodSugar,lunchBloodSugar,dinnerBloodSugar,remark);
        }
