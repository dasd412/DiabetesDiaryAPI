...
public class ChartsRestController {
    ...
    public ApiResult<List<DiaryListResponseDTO>>getDiaryListBetween(@RequestParam Map<String, Object> allParameters){
        /*
        ...
        List<DiabetesDiary>list=  chartsService.getDiaryListBetween((String)allParameters.get("startDate"),(String)allParameters.get("endDate"));
