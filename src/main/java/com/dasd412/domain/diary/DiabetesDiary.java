...
public class DiabetesDiary extends BaseTimeEntity {
  ...
  public DiabetesDiary(int fastingPlasmaGlucose, int breakfastBloodSugar, int lunchBloodSugar,
      int dinnerBloodSugar) {
    this(null, fastingPlasmaGlucose, breakfastBloodSugar, lunchBloodSugar, dinnerBloodSugar, "",
        null);
  }

  public DiabetesDiary(int fastingPlasmaGlucose, int breakfastBloodSugar, int lunchBloodSugar,
      int dinnerBloodSugar, String remark) {
    this(null, fastingPlasmaGlucose, breakfastBloodSugar, lunchBloodSugar, dinnerBloodSugar, remark,
        null);
  }

  public DiabetesDiary(Long id, int fastingPlasmaGlucose, int breakfastBloodSugar,
      int lunchBloodSugar, int dinnerBloodSugar, String remark, LocalDateTime writtenTime) {
  ...
  public void update(int fastingPlasmaGlucose, int breakfastBloodSugar, int lunchBloodSugar,
      int dinnerBloodSugar, String remark) {
  ...
  static public class Builder {
    ...
    public DiabetesDiary build() {
      return new DiabetesDiary(id, fastingPlasmaGlucose, breakfastBloodSugar, lunchBloodSugar,
          dinnerBloodSugar, remark, writtenTime);
    }
